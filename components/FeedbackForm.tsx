      ...
      {!showForm ? (
        <div className={styles.FeedbackFormCard}>
          ...
          <div className={styles.FeedbackFormBody}>
            <p>
              Sending positive and detailed comments helps encourage professors
              to publish more course notes :)
            </p>
            <button
              className={styles.FeedbackFormCommentBtn}
        ...
        <div>
          ...
          <form className={styles.FeedbackFormForm} onSubmit={handleSubmit}>
            ...
            <div className={styles.submitButtonRow}>
              <button type='submit' className={styles.FeedbackFormSubmitBtn}>
                →
              </button>
            </div>
          </form>
