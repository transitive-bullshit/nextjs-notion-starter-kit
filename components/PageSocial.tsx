...
const socialLinks: SocialLink[] = [
  config.twitter && {
    ...
    // <svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 24 24'>
     ...
     // </svg>
      <svg t="1687069378201" class="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="621" width="200" height="200"><path d="M512 96l480 832H32z" p-id="622"></path></svg>
    )
  },
