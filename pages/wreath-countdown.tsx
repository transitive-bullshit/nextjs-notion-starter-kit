...
const WreathCountdown= () => {
    return <a href="https://sherwoodfundraiser.com/frc6995nomad/products"><div style={{display:"flex", alignItems:"center", justifyContent:"center", width:"100vw", height:"100vh", backgroundImage:`url('/wreath.jpg')`, backgroundRepeat:"no-repeat", backgroundSize:"auto 100%", backgroundPosition:"center", color:"white", fontSize:"12vw", fontWeight:"bolder"}}>
